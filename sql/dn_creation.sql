...
||
|| $Log: dn_creation.sql,v $
|| Revision 1.8  2016/09/07 12:56:46  shmyg
|| *** empty log message ***
||
|| Revision 1.7  2016/08/04 10:36:56  shmyg
|| *** empty log message ***
||
|| Revision 1.6  2016/08/01 13:47:14  shmyg
|| *** empty log message ***
||
|| Revision 1.5  2016/06/08 15:31:56  shmyg
|| *** empty log message ***
||
...
DECLARE
	...
	c_rscode		CONSTANT PLS_INTEGER := 144; -- ONT
--	c_rscode		CONSTANT PLS_INTEGER := 2;
	c_prefix		CONSTANT VARCHAR2(12) := '1000000002'; -- ONT
--	c_prefix		CONSTANT VARCHAR2(12) := '1868';
--	c_ndc			CONSTANT VARCHAR2(3) := '868';
	c_ndc			VARCHAR2(3) := NULL; -- ONT
	c_dealer_id		CONSTANT PLS_INTEGER := 2;
	c_hmcode		CONSTANT PLS_INTEGER := 13; -- ONT
--	c_hmcode		CONSTANT PLS_INTEGER := 22;
--	c_local_prefix_len	CONSTANT PLS_INTEGER := 4;
	c_local_prefix_len	CONSTANT PLS_INTEGER := 0; -- ONT
	c_dn_type		CONSTANT PLS_INTEGER := 40; -- ONT
--	c_dn_type		CONSTANT PLS_INTEGER := 2;
