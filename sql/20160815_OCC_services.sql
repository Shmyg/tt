/*
|| Script to insert missing OCC services
|| Created by Serge Shmygelskyy aka Shmyg
|| mailto: serge.shmygelskyy@gmail.com
|| 
|| $Log: 20160815_OCC_services.sql,v $
|| Revision 1.1  2016/08/18 07:55:16  shmyg
|| *** empty log message ***
||
||
*/
...
DECLARE
	...
	c_filename	CONSTANT VARCHAR2(100) := '20160815_OCC_services.sql';
	c_description	CONSTANT VARCHAR2(100) := 'Configuration of OCC services';
...
FOR	rec IN (SELECT 'YUMED' AS des FROM DUAL UNION SELECT 'YUNAC' AS des FROM DUAL)
LOOP
	...
	VALUES	(
	       	v_sncode,
		DECODE (rec.des, 'YUMED', 'Media Player for YuppTV', 'YUNAC', 'No additional charge' ),
		'N',
		1,
		NULL,
		'N',
	...
	VALUES	(
		v_evcode,
		DECODE (rec.des, 'YUMED', 'Media Player for YuppTV', 'YUNAC', 'YuppTV - no additional charge' ),
		'A',
		'B',
		'O',
		0,
	...
	VALUES	(
		...
		NULL,
		NULL,
		DECODE (rec.des, 'YUMED', 300, 'YUNAC', 0 ),
		'A',
		'C',
		'O',
		'E',
