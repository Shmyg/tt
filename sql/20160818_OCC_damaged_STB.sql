/*
|| Script to insert OCC service for a damaged CPE
|| Created by Serge Shmygelskyy aka Shmyg
|| mailto: serge.shmygelskyy@gmail.com
|| 
|| $Log: 20160818_OCC_damaged_STB.sql,v $
|| Revision 1.1  2016/08/18 14:45:50  shmyg
|| Added OCC for the damaged CPE
||
*/

DECLARE

	c_filename	CONSTANT VARCHAR2(100) := '20160818_OCC_damaged_STB.sql';
	c_description	CONSTANT VARCHAR2(100) := 'Configuration of OCC service for a damaged CPE';
	c_bug_id	CONSTANT PLS_INTEGER := '4152';
	...
	v_shdes		CONSTANT VARCHAR2(10) := 'DAMAG';
	v_des		CONSTANT VARCHAR2(100) := 'Penatly for damaged CPE';
	v_amount	CONSTANT NUMBER := 100;
