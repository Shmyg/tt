...
<!--
  ...
  This stylesheet draws type 128 barcodes.
  VERSION = @(#) ./lhsj_main/bscs/batch/src/bgh/LAYOUT/code128.xsl, , CBIO_PCP1503, CBIO_PCP1503_150728 @@CBIO_PCP1503_150728 28-Jul-2015
  
  Author: Alexander Peshkov <peshkov@renderx.com> (c) 2003, RenderX
  
-->

<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:my="http://www.128-data.org">
