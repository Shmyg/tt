...
<!--
  ...
  VERSION = @(#) ./lhsj_main/bscs/batch/src/bgh/LAYOUT/CallDetailStatementCSV.xsl, , CBIO_PCP1503, CBIO_PCP1503_150728 @@CBIO_PCP1503_150728 28-Jul-2015
    ...
    <xsl:for-each select="$call-detail-statement">
      ...
      <xsl:if test="position()='1'">
        ...
        <bgh:row>
            <bgh:cell/>
            <bgh:cell>
                    <xsl:for-each select="$txt"><!-- Last bill date -->
