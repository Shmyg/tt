...
<!--
  ...
  File:    ContractSharedAccounts.xsl
  ...
  VERSION = @(#) ./lhsj_main/bscs/batch/src/bgh/LAYOUT/ContractSharedAccounts.xsl, , CBIO_PCP1503, CBIO_PCP1503_150728 @@CBIO_PCP1503_150728 28-Jul-2015
