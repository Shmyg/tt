...
<!--
  ...
  This stylesheet drawes UPC-EAN barcodes.
  VERSION = @(#) ./lhsj_main/bscs/batch/src/bgh/LAYOUT/upc-ean-svg.xsl, , CBIO_PCP1503, CBIO_PCP1503_150728 @@CBIO_PCP1503_150728 28-Jul-2015
  
  Author: Nikolai Grigoriev <grig@renderx.com> (c) 2003, RenderX
...
<xsl:template name="draw-barcode-EAN">
  ...
  <xsl:variable name="font-height" select="6"/>
