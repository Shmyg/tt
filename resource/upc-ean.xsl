...
<!--
  ...
  This stylesheet draws UPC-EAN barcodes.
  VERSION = @(#) ./lhsj_main/bscs/batch/src/bgh/LAYOUT/upc-ean.xsl, , CBIO_PCP1503, CBIO_PCP1503_150728 @@CBIO_PCP1503_150728 28-Jul-2015
...
<xsl:template name="barcode-EAN">
  ...
  <xsl:param name="module" select="'0.30mm'"/>
